...
if os.path.exists(".git") and shutil.which("git"):
    try:
        ...
        git_revision_url = f"https://github.com/kevin-brown/matrix-groupme/commit/{git_revision}"
...
git_tag_url = f"https://github.com/kevin-brown/matrix-groupme/releases/tag/{git_tag}" if git_tag else None
